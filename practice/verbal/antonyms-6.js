const synqQuestions = [
  {
    ...
    options: ["Kind", "Malevolent", "Compassionate", "Generous"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    prompt: "Choose the antonym of CACOPHONY.",
    options: ["Noise", "Harmony", "Discord", "Chaos"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    ...
    options: ["Honest", "Deceptive", "Truthful", "Frank"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    prompt: "Choose the antonym of CATALYST.",
    options: ["Cause", "Inhibitor", "Trigger", "Instigator"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    prompt: "Choose the antonym of COGENT.",
    options: ["Convincing", "Weak", "Compelling", "Persuasive"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    prompt: "Choose the antonym of COHERENT.",
    options: ["Logical", "Incoherent", "Clear", "Consistent"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    prompt: "Choose the antonym of COMPLACENT.",
    options: ["Self-satisfied", "Ambitious", "Contented", "Smug"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    ...
    options: ["Brief", "Verbose", "Succinct", "Short"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    prompt: "Choose the antonym of CONDONE.",
    options: ["Overlook", "Punish", "Forgive", "Excuse"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    prompt: "Choose the antonym of CONFUTE.",
    options: ["Disprove", "Validate", "Refute", "Rebut"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
