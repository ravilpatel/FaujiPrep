const synqQuestions = [
  {
    prompt: "Choose the synonym of SHINY.",
    options: ["Dull", "Glossy", "Dim", "Muddy"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 17,
  },
  {
    prompt: "Choose the synonym of FINAL.",
    options: ["Initial", "Ultimate", "Early", "Primary"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of HONOR.",
    options: ["Shame", "Respect", "Mockery", "Insult"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of NEAR.",
    options: ["Distant", "Close", "Remote", "Far"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 20,
  },
  {
    prompt: "Choose the synonym of CANDID.",
    options: ["Frank", "Crafty", "Hidden", "Reserved"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of ARDUOUS.",
    options: ["Simple", "Demanding", "Easy", "Smooth"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of MERIT.",
    options: ["Fault", "Worth", "Blame", "Defect"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of STEADFAST.",
    options: ["Uncertain", "Firm", "Hesitant", "Shaky"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the synonym of ELUSIVE.",
    options: ["Obvious", "Hard to catch", "Visible", "Simple"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the synonym of EMPATHY.",
    options: ["Indifference", "Compassion", "Cruelty", "Neglect"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
