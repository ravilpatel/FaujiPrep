const synqQuestions = [
  {
    ...
    options: ["Lachrymose", "Maudlin", "Dolorous", "Hilarious"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Querulous", "Petulant", "Cantankerous", "Docile"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Pellucid", "Limpid", "Translucent", "Turbid"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Penurious", "Parsimonious", "Niggardly", "Profuse"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Sedulous", "Assiduous", "Diligent", "Negligent"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Propitious", "Salutary", "Auspicious", "Pernicious"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Perspicacious", "Discerning", "Judicious", "Myopic"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Inchoate", "Nascent", "Fledgling", "Consummate"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Voluble", "Garrulous", "Loquacious", "Reticent"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Pusillanimous", "Craven", "Intrepid", "Timid"],
    answer: 2,
    difficulty: "Hard",
    timeLimit: 20,
  },
