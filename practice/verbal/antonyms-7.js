const synqQuestions = [
  {
    prompt: "Choose the antonym of DEBASE.",
    options: ["Degrade", "Elevate", "Demean", "Lower"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    prompt: "Choose the antonym of DEBILITATE.",
    options: ["Weaken", "Invigorate", "Enfeeble", "Exhaust"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  },
  {
    prompt: "Choose the antonym of DEFERENCE.",
    options: ["Respect", "Insolence", "Reverence", "Courtesy"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  },
  {
    prompt: "Choose the antonym of DEFICIENT.",
    options: ["Lacking", "Abundant", "Insufficient", "Limited"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  },
  {
    prompt: "Choose the antonym of DEFERENTIAL.",
    options: ["Respectful", "Assertive", "Submissive", "Polite"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  },
  {
    prompt: "Choose the antonym of DEFUNCT.",
    options: ["Inactive", "Operational", "Dead", "Extinct"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  },
  {
    prompt: "Choose the antonym of DEGENERATE.",
    options: ["Deteriorate", "Regenerate", "Decline", "Worsen"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  },
  {
    prompt: "Choose the antonym of DEGRADE.",
    options: ["Demote", "Honor", "Lower", "Humiliate"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  },
  {
    prompt: "Choose the antonym of DEIFY.",
    options: ["Worship", "Dethrone", "Idolize", "Exalt"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the antonym of DELETERIOUS.",
    options: ["Harmful", "Beneficial", "Injurious", "Damaging"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
