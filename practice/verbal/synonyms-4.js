const synqQuestions = [
  {
    prompt: "Choose the synonym of CALM.",
    options: ["Agitated", "Peaceful", "Loud", "Rough"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 17,
  },
  {
    prompt: "Choose the synonym of LOYAL.",
    options: ["Faithful", "Treacherous", "Fickle", "Hostile"],
    answer: 0,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of CAREFUL.",
    options: ["Reckless", "Cautious", "Hasty", "Wild"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of KIND.",
    options: ["Gentle", "Cruel", "Harsh", "Cold"],
    answer: 0,
    difficulty: "Easy",
    timeLimit: 17,
  },
  {
    prompt: "Choose the synonym of ANGRY.",
    options: ["Pleased", "Furious", "Mild", "Calm"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of HOLLOW.",
    options: ["Solid", "Empty", "Thick", "Dense"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 20,
  },
  {
    prompt: "Choose the synonym of PRECISE.",
    options: ["Vague", "Accurate", "Broad", "Approximate"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of OBSCURE.",
    options: ["Famous", "Unclear", "Bright", "Popular"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of ADVERSE.",
    options: ["Supportive", "Unfavorable", "Helpful", "Pleasant"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the synonym of ALLEVIATE.",
    options: ["Worsen", "Relieve", "Increase", "Provoke"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
