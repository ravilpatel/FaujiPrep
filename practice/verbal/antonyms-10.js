const synqQuestions = [
  {
    prompt: "Choose the antonym of GARRULOUS.",
    options: ["Talkative", "Taciturn", "Loquacious", "Verbose"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of GLIB.",
    options: ["Fluent", "Sincere", "Smooth", "Eloquent"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of GLUTTONY.",
    options: ["Excess", "Asceticism", "Indulgence", "Greed"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GRANDILOQUENT.",
    options: ["Pompous", "Humble", "Boastful", "Extravagant"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GRATUITOUS.",
    options: ["Uncalled-for", "Necessary", "Unwanted", "Unjustified"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GREGARIOUS.",
    options: ["Sociable", "Solitary", "Companionable", "Clubby"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GROUSE.",
    options: ["Complain", "Praise", "Lament", "Grumble"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GUILELESS.",
    options: ["Naive", "Cunning", "Innocent", "Artless"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GULLIBLE.",
    options: ["Credulous", "Shrewd", "Naive", "Trusting"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the antonym of GUSTY.",
    options: ["Windy", "Calm", "Blustery", "Stormy"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
