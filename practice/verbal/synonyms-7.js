const synqQuestions = [
  {
    ...
    options: ["Lengthy", "Short", "Extended", "Massive"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 16,
  },
  {
    prompt: "Choose the synonym of VALOR.",
    options: ["Cowardice", "Courage", "Fear", "Timidity"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of MODEST.",
    options: ["Humble", "Arrogant", "Vain", "Showy"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of INTENSE.",
    options: ["Mild", "Extreme", "Soft", "Gentle"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of RIGID.",
    options: ["Flexible", "Stiff", "Loose", "Soft"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of PERSUADE.",
    options: ["Convince", "Deter", "Refuse", "Avoid"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of REVERED.",
    options: ["Despised", "Respected", "Ignored", "Insulted"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the synonym of FICKLE.",
    options: ["Steady", "Inconstant", "Firm", "Loyal"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of INFER.",
    options: ["Conclude", "Deny", "Ignore", "Forget"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of PRUDENT.",
    options: ["Careful", "Rash", "Careless", "Foolish"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 29,
  },
