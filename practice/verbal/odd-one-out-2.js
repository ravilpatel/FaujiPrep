const synqQuestions = [
  {
    ...
    options: ["Milk", "Butter", "Cheese", "Hammer"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Tiger", "Lion", "Elephant", "Bicycle"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Doctor", "Teacher", "Nurse", "Cloud"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Square", "Circle", "Triangle", "Fragrance"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Football", "Cricket", "Tennis", "Television"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Car", "Train", "Bus", "Computer"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Shirt", "Trousers", "Socks", "Plate"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Apple", "Mango", "Grape", "Carriage"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["River", "Lake", "Ocean", "Desert"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
