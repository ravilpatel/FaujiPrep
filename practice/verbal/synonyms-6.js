const synqQuestions = [
  {
    prompt: "Choose the synonym of HONORABLE.",
    options: ["Noble", "Petty", "Mean", "Corrupt"],
    answer: 0,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of RAPTURE.",
    options: ["Delight", "Sorrow", "Regret", "Shock"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of FERTILE.",
    options: ["Barren", "Productive", "Dry", "Infertile"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of UPRIGHT.",
    options: ["Dishonest", "Ethical", "Crooked", "Biased"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of VIGOROUS.",
    options: ["Weak", "Energetic", "Inactive", "Faint"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of IMMENSE.",
    options: ["Tiny", "Huge", "Minor", "Light"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of FRIVOLOUS.",
    options: ["Serious", "Trivial", "Important", "Profound"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the synonym of SCRUTINIZE.",
    options: ["Ignore", "Examine", "Neglect", "Dismiss"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of BENEVOLENT.",
    options: ["Kind", "Cruel", "Hostile", "Harsh"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of LETHARGIC.",
    options: ["Active", "Sluggish", "Vivid", "Brisk"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
