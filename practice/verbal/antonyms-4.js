const synqQuestions = [
  {
    ...
    options: ["Plentiful", "Scarce", "Rich", "Copious"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Choose the antonym of AGGRESSIVE.",
    options: ["Hostile", "Peaceful", "Combative", "Violent"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 20,
  },
  {
    prompt: "Choose the antonym of ARROGANT.",
    options: ["Conceited", "Humble", "Proud", "Vain"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 20,
  },
  {
    prompt: "Choose the antonym of CAREFUL.",
    options: ["Cautious", "Careless", "Attentive", "Meticulous"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 19,
  },
  {
    prompt: "Choose the antonym of CLEVER.",
    options: ["Smart", "Foolish", "Intelligent", "Astute"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 19,
  },
  {
    prompt: "Choose the antonym of DILIGENT.",
    options: ["Industrious", "Lazy", "Conscientious", "Assiduous"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 20,
  },
  {
    prompt: "Choose the antonym of ELOQUENT.",
    options: ["Articulate", "Silent", "Fluent", "Expressive"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 21,
  },
  {
    prompt: "Choose the antonym of FIERCE.",
    options: ["Violent", "Gentle", "Wild", "Intense"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 21,
  },
  {
    prompt: "Choose the antonym of FRAGILE.",
    options: ["Delicate", "Robust", "Brittle", "Frail"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 21,
  },
  {
    prompt: "Choose the antonym of GENEROUS.",
    options: ["Liberal", "Stingy", "Charitable", "Magnanimous"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 21,
  },
