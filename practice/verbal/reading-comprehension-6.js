const rcPassage = `
<p>Throughout history, artistic revolutions have emerged not from technical innovation alone, but from shifts in how artists perceive and interpret the world. The Renaissance masters did not simply master perspective through mathematical calculation; they fundamentally reconceived human agency and dignity. Similarly, the Impressionists were not merely experimenting with light and color; they were challenging the academy's monopoly on what constituted 'proper' subject matter and worthy observation. Yet in contemporary discourse, we often reduce artistic evolution to technological advancement—the camera replaced portraiture, digital tools democratized design—while overlooking how worldview, cultural anxiety, and philosophical inquiry drive genuine artistic transformation. This conflation of medium with meaning obscures the deeper currents of intellectual and cultural ferment that animate true artistic innovation.</p>
`;

const synqQuestions = [
  {
    prompt: "What is the author's primary criticism regarding contemporary views of artistic progress?",
    options: [
      "Technology has had no impact on art",
      "Art is purely about technical skill",
      "We attribute artistic change to technology while ignoring philosophical and cultural drivers",
      "Artistic innovation is impossible in the modern era"
    ],
    answer: 2,
    difficulty: "Hard",
    timeLimit: 25,
  ...
  {
    prompt: "How do the Renaissance and Impressionist examples support the author's argument?",
    options: [
      "They show that technical skill is irrelevant",
      "They demonstrate that major artistic shifts involve reconceiving the nature of art itself, not just technical changes",
      "They prove that new art movements are random",
      "They illustrate that traditional art was superior"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  ...
  {
    prompt: "What does the author mean by saying technology 'replaced portraiture'?",
    options: [
      "Photography literally destroyed the practice of portrait painting",
      "The author is citing a common but incomplete explanation for artistic change",
      "Portraits are no longer valuable",
      "The camera was the only cause of artistic innovation"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  ...
  {
    prompt: "What is the tone of the phrase 'cultural anxiety and philosophical inquiry'?",
    options: [
      "Dismissive of culture and philosophy",
      "Serious and elevating them as significant drivers of art",
  ...
  {
    prompt: "What does 'obscures the deeper currents' suggest about the relationship between visible causes and underlying forces?",
    options: [
      "The deeper forces are not real",
      "Focusing on obvious external changes masks the fundamental intellectual and cultural transformations driving art",
      "Currents and forces are the same thing",
      "Artists intentionally hide their motivations"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
