const rcPassage = `
<p>Every morning, the old lighthouse keeper climbed the spiral stairs with unwavering determination, despite the aching in his joints. For fifty years, he had maintained the beacon, watching over countless ships as they navigated the treacherous waters below. Though technology had advanced and modern navigation systems had replaced much of his manual work, he continued his daily ritual with pride. He knew that one day, automated systems would render his position obsolete, but until then, he would ensure that the light never failed.</p>
`;

const synqQuestions = [
  {
    prompt: "What can we infer about the lighthouse keeper's attitude toward his job?",
    options: [
      "He resents the advancement of technology",
      "He finds his work repetitive and tiring",
      "He takes pride in his responsibility despite physical challenges",
  ...
  {
    prompt: "Why does the keeper continue his work despite knowing technology has replaced it?",
    options: [
      "He has nowhere else to go",
      "He is stubborn and refuses change",
      "He values his duty and takes pride in maintaining the light",
  ...
  {
    prompt: "What does the phrase 'the light never failed' suggest?",
    options: [
      "The lighthouse equipment was very reliable",
      "The keeper's dedication to his responsibility",
      "Modern technology was not trustworthy",
      "Ships never got lost in the waters"
    ],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 20,
