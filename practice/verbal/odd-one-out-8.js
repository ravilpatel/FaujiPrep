const synqQuestions = [
  {
    ...
    options: ["Felicitous", "Propitious", "Auspicious", "Inauspicious"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Circumlocution", "Periphrasis", "Verbosity", "Terseness"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Indefatigable", "Assiduous", "Sedulous", "Indolent"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Surreptitious", "Clandestine", "Furtive", "Overt"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Perspicacious", "Sagacious", "Prescient", "Obtuse"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Pusillanimous", "Craven", "Timorous", "Valorous"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Ubiquitous", "Omnipresent", "Pervasive", "Sparse"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Munificent", "Magnanimous", "Benevolent", "Miserly"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Ebullient", "Effervescent", "Loquacious", "Morose"],
    answer: 2,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Inimical", "Antithetical", "Adversarial", "Consonant"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
