const synqQuestions = [
  {
    prompt: "Choose the synonym of JOYFUL.",
    options: ["Miserable", "Happy", "Gloomy", "Irritable"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 16,
  },
  {
    prompt: "Choose the synonym of SILENT.",
    options: ["Noisy", "Calm", "Talkative", "Rough"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 17,
  },
  {
    prompt: "Choose the synonym of TINY.",
    options: ["Huge", "Microscopic", "Tall", "Broad"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 17,
  },
  {
    prompt: "Choose the synonym of POLITE.",
    options: ["Courteous", "Rude", "Harsh", "Wild"],
    answer: 0,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of SIMPLE.",
    options: ["Plain", "Complex", "Confusing", "Dense"],
    answer: 0,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of HONEST.",
    options: ["Truthful", "Crafty", "False", "Dubious"],
    answer: 0,
    difficulty: "Easy",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of FRAGILE.",
    options: ["Sturdy", "Breakable", "Dense", "Rigid"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of VISIBLE.",
    options: ["Obvious", "Hidden", "Masked", "Unknown"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 20,
  },
  {
    prompt: "Choose the synonym of WISDOM.",
    options: ["Ignorance", "Knowledge", "Folly", "Impulse"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of DETEST.",
    options: ["Admire", "Acknowledge", "Loathe", "Accept"],
    answer: 2,
    difficulty: "Hard",
    timeLimit: 26,
  },
