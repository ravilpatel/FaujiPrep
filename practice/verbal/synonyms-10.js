const synqQuestions = [
  {
    prompt: "Choose the synonym of BENIGN.",
    options: ["Harmless", "Hostile", "Cruel", "Savage"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 18,
  },
  {
    prompt: "Choose the synonym of CIRCUMSPECT.",
    options: ["Careful", "Careless", "Wild", "Rash"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of DISPARAGE.",
    options: ["Praise", "Belittle", "Admire", "Honor"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 24,
  },
  {
    prompt: "Choose the synonym of INGENUOUS.",
    options: ["Sincere", "Cunning", "Devious", "Crafty"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of PERFUNCTORY.",
    options: ["Thorough", "Superficial", "Detailed", "Careful"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of SAGACIOUS.",
    options: ["Wise", "Foolish", "Naive", "Simple"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the synonym of SPURIOUS.",
    options: ["Authentic", "False", "Genuine", "Real"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the synonym of UBIQUITOUS.",
  ...
  {
    prompt: "Choose the synonym of VENERATE.",
    options: ["Despise", "Revere", "Ignore", "Mock"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the synonym of ZEALOUS.",
    options: ["Indifferent", "Passionate", "Cold", "Uninterested"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
