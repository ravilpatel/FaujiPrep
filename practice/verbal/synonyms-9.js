const synqQuestions = [
  {
    prompt: "Choose the synonym of BRITTLE.",
    options: ["Flexible", "Fragile", "Strong", "Solid"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of COGENT.",
    options: ["Convincing", "Weak", "Doubtful", "Random"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of ABATE.",
    options: ["Increase", "Lessen", "Expand", "Multiply"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of CANDOR.",
    options: ["Evasion", "Frankness", "Deceit", "Silence"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of PRECARIOUS.",
  ...
  {
    prompt: "Choose the synonym of MITIGATE.",
    options: ["Aggravate", "Ease", "Complicate", "Magnify"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of OBSTINATE.",
    options: ["Compliant", "Stubborn", "Gentle", "Docile"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of EPHEMERAL.",
    options: ["Enduring", "Brief", "Permanent", "Lasting"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the synonym of ABERRATION.",
    options: ["Norm", "Deviation", "Routine", "Pattern"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 30,
  },
  {
    prompt: "Choose the synonym of LUCID.",
    options: ["Confusing", "Clear", "Muddled", "Vague"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
