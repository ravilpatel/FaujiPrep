const rcPassage = `
<p>The concept of 'wilderness' as an untouched natural space is largely a modern invention, often serving ideological purposes rather than ecological ones. Indigenous peoples have inhabited and managed landscapes for millennia, shaping ecosystems through controlled burning, selective harvesting, and other sustainable practices. Yet contemporary conservation efforts frequently exclude these communities in the name of preserving 'pristine' nature, paradoxically degrading ecosystems that had flourished under indigenous stewardship. This contradiction reflects a profound misunderstanding of ecological history and reveals how Western assumptions about nature can undermine the very conservation goals they claim to serve. Recognizing indigenous land management practices as legitimate conservation strategies represents not merely a moral imperative, but an ecological necessity.</p>
`;

const synqQuestions = [
  {
    prompt: "What is the author's stance on the concept of 'wilderness'?",
    options: [
      "It is an accurate representation of natural landscapes",
      "It is a modern construct that often contradicts ecological reality",
      "It is exclusively a native concept",
      "It is irrelevant to modern conservation"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  ...
  {
    prompt: "How does the passage characterize the relationship between indigenous practices and ecosystem health?",
    options: [
      "Indigenous practices are destructive to ecosystems",
      "Indigenous stewardship has sustainably maintained and improved ecosystem health",
      "Indigenous practices are unrelated to ecosystem management",
      "Ecosystems would thrive better without human intervention"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
  ...
  {
    prompt: "What does the author mean by calling the conservation contradiction 'paradoxical'?",
    options: [
      "Modern conservation never achieves its goals",
      "Excluding indigenous peoples in the name of preserving nature actually harms the ecosystems that indigenous practices had protected",
      "Indigenous peoples want to destroy forests",
      "There is no contradiction between Western and indigenous approaches"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 24,
  ...
  {
    prompt: "What tone does the author adopt when discussing Western assumptions about nature?",
    options: [
  ...
  {
    prompt: "Why does the author state that recognizing indigenous practices is 'not merely a moral imperative, but an ecological necessity'?",
    options: [
      "Indigenous peoples have more land than others",
      "Including indigenous stewardship is both ethically right and scientifically essential for effective conservation",
      "Moral considerations always outweigh ecological ones",
      "Indigenous practices have no real ecological impact"
    ],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 25,
