const synqQuestions = [
  {
    ...
    options: ["Brevity", "Conciseness", "Verbosity", "Succinctness"],
    answer: 2,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Ameliorate", "Exacerbate", "Alleviate", "Mitigate"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Philanthropist", "Altruist", "Benefactor", "Misanthrope"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Cogent", "Compelling", "Persuasive", "Trivial"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Fastidious", "Meticulous", "Scrupulous", "Negligent"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["Sanguine", "Optimistic", "Hopeful", "Despondent"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Ebullient", "Exuberant", "Vivacious", "Morose"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Obfuscate", "Clarify", "Obscure", "Muddle"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Profligate", "Extravagant", "Lavish", "Frugal"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
