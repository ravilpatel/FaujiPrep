const synqQuestions = [
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["Spider", "Ant", "Bee", "Submarine"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Milk", "Curd", "Cheese", "Paper"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Book", "Magazine", "Newspaper", "Cup"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["Strawberry", "Raspberry", "Blueberry", "Mushroom"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Helmet", "Gloves", "Boots", "Water"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Guitar", "Piano", "Harp", "Telescope"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Hammer", "Wrench", "Screwdriver", "Candle"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Yoga", "Swimming", "Running", "Stone"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
