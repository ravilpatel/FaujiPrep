const synqQuestions = [
  {
    prompt: "Choose the antonym of HOT.",
    options: ["Warm", "Cold", "Tepid", "Mild"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 15,
  },
  {
    prompt: "Choose the antonym of BIG.",
  ...
  {
    prompt: "Choose the antonym of GOOD.",
    options: ["Excellent", "Bad", "Better", "Best"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 14,
  },
  {
    ...
    options: ["Cheerful", "Sad", "Joyful", "Content"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 15,
  },
  {
    prompt: "Choose the antonym of LIGHT.",
    options: ["Bright", "Dark", "Clear", "Pale"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 14,
  },
  {
    prompt: "Choose the antonym of FAST.",
    options: ["Swift", "Slow", "Quick", "Rapid"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 15,
  },
  {
    prompt: "Choose the antonym of HIGH.",
    options: ["Tall", "Low", "Elevated", "Upper"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 14,
  },
  {
    prompt: "Choose the antonym of CLEAN.",
    options: ["Neat", "Dirty", "Pure", "Spotless"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 15,
  },
  {
    prompt: "Choose the antonym of STRONG.",
    options: ["Powerful", "Weak", "Vigorous", "Robust"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 15,
  },
  {
    prompt: "Choose the antonym of LOUD.",
    options: ["Noisy", "Quiet", "Deafening", "Shrill"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 15,
  },
