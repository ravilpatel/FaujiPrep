const synqQuestions = [
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["Running", "Walking", "Swimming", "Blue"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["Red", "Green", "Yellow", "Happy"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["January", "Monday", "March", "August"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Rose", "Tulip", "Daisy", "Grass"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Piano", "Guitar", "Trumpet", "Hammer"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Winter", "Spring", "Fall", "Weather"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["London", "Paris", "Berlin", "Mountain"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
