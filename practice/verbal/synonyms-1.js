const synqQuestions = [
  {
    prompt: "Choose the synonym of BRAVE.",
    options: ["Cowardly", "Timid", "Valiant", "Weak"],
    answer: 2,
    difficulty: "Easy",
    timeLimit: 18,
  },
  ...
  },
  {
    ...
    options: ["Scarce", "Plentiful", "Little", "Tiny"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 20,
  },
  {
    ...
    options: ["Modern", "Recent", "Old", "Fresh"],
    answer: 2,
    difficulty: "Easy",
    timeLimit: 16,
  },
  {
    prompt: "Choose the synonym of DILIGENT.",
    options: ["Careless", "Hardworking", "Idle", "Weak"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of HOSTILE.",
    options: ["Friendly", "Uncertain", "Aggressive", "Calm"],
    answer: 2,
    difficulty: "Easy",
    timeLimit: 20,
  },
  {
    prompt: "Choose the synonym of RESOLUTE.",
    options: ["Determined", "Confused", "Fearful", "Passive"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 24,
  },
  {
    prompt: "Choose the synonym of TRANSPARENT.",
    options: ["Clear", "Hidden", "Dark", "Silent"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 19,
  },
  {
    prompt: "Choose the synonym of CEASE.",
    options: ["Begin", "Continue", "Stop", "Move"],
    answer: 2,
    difficulty: "Medium",
    timeLimit: 26,
  },
  {
    prompt: "Choose the synonym of RELIABLE.",
    options: ["Trustworthy", "Doubtful", "Fragile", "Costly"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 25,
  },
