const synqQuestions = [
  {
    ...
    options: ["Bellicose", "Pugnacious", "Belligerent", "Pacifist"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Euphemism", "Circumlocution", "Periphrasis", "Directness"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Esoteric", "Hermetic", "Obscurantist", "Exoteric"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Deleterious", "Noxious", "Pernicious", "Salutary"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Contumacious", "Recalcitrant", "Obstreperous", "Docile"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Perspicuity", "Lucidity", "Clarity", "Obfuscation"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Sagacious", "Perspicacious", "Prescient", "Obtuse"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Profligate", "Sybaritic", "Epicurean", "Spartan"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Encomium", "Eulogium", "Panegyric", "Diatribe"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Verisimilitude", "Authenticity", "Veracity", "Fabrication"],
    answer: 3,
    difficulty: "Hard",
    timeLimit: 20,
  },
...
function downloadSynqQuestionsPdf() {
  ...
  const heading = document.querySelector(".synq-head h1")?.textContent?.trim() || "Odd One Out Quiz";
  const marginX = 40;
  const lineWidth = 515;
