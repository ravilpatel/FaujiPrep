const synqQuestions = [
  {
    prompt: "Choose the antonym of EPHEMERAL.",
    options: ["Fleeting", "Permanent", "Transient", "Brief"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the antonym of EQUANIMITY.",
    options: ["Calmness", "Agitation", "Serenity", "Composure"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the antonym of ERUDITE.",
    options: ["Scholarly", "Ignorant", "Learned", "Educated"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the antonym of ESOTERIC.",
    options: ["Obscure", "Exoteric", "Abstruse", "Cryptic"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the antonym of ESTEEM.",
    options: ["Respect", "Contempt", "Regard", "Honor"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 26,
  },
  {
    prompt: "Choose the antonym of ETHEREAL.",
    options: ["Heavenly", "Substantial", "Celestial", "Spiritual"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of EULOGY.",
    options: ["Praise", "Censure", "Commendation", "Tribute"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of EVOKE.",
    options: ["Summon", "Suppress", "Elicit", "Arouse"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of EXACERBATE.",
    options: ["Worsen", "Ameliorate", "Aggravate", "Intensify"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of EXALT.",
    options: ["Elevate", "Debase", "Raise", "Glorify"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
