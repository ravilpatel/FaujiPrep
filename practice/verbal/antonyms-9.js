const synqQuestions = [
  {
    prompt: "Choose the antonym of FARCICAL.",
    options: ["Comedic", "Serious", "Ridiculous", "Absurd"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of FASTIDIOUS.",
    options: ["Meticulous", "Slovenly", "Particular", "Scrupulous"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of FATALISTIC.",
    options: ["Resigned", "Optimistic", "Deterministic", "Doom-ridden"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the antonym of FATHOMABLE.",
    options: ["Understandable", "Inscrutable", "Comprehensible", "Clear"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of FELICITOUS.",
    options: ["Appropriate", "Inauspicious", "Timely", "Suitable"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of FERVENT.",
    options: ["Passionate", "Apathetic", "Zealous", "Ardent"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of FETID.",
    options: ["Putrid", "Fragrant", "Malodorous", "Foul-smelling"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of FICKLE.",
    options: ["Unreliable", "Constant", "Capricious", "Changeable"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of FINICKY.",
    options: ["Particular", "Undemanding", "Choosy", "Selective"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the antonym of FLORID.",
    options: ["Ornate", "Plain", "Elaborate", "Flowery"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
