const synqQuestions = [
  {
    ...
    options: ["Fearless", "Cowardly", "Valiant", "Bold"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 16,
  },
  {
    prompt: "Choose the antonym of KIND.",
    options: ["Gentle", "Cruel", "Compassionate", "Tender"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 16,
  },
  {
    prompt: "Choose the antonym of RICH.",
    options: ["Wealthy", "Poor", "Prosperous", "Affluent"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 16,
  },
  {
    prompt: "Choose the antonym of YOUNG.",
    options: ["Fresh", "Old", "Youthful", "Juvenile"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 16,
  },
  {
    prompt: "Choose the antonym of SHARP.",
    options: ["Keen", "Dull", "Acute", "Pointed"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Choose the antonym of BRIGHT.",
    options: ["Luminous", "Dim", "Radiant", "Brilliant"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Choose the antonym of SOFT.",
    options: ["Tender", "Hard", "Smooth", "Gentle"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Choose the antonym of THICK.",
    options: ["Dense", "Thin", "Concentrated", "Viscous"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Choose the antonym of HEAVY.",
    options: ["Massive", "Light", "Substantial", "Weighty"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Choose the antonym of TALL.",
    options: ["Elevated", "Short", "Lofty", "Towering"],
    answer: 1,
    difficulty: "Easy",
    timeLimit: 16,
  },
