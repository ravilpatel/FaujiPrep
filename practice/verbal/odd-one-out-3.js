const synqQuestions = [
  {
    ...
    options: ["Sparrow", "Eagle", "Pigeon", "Salmon"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Rose", "Sunflower", "Lily", "Bridge"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Sword", "Knife", "Spoon", "Arrow"],
    answer: 2,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Diamond", "Ruby", "Sapphire", "Mud"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Violin", "Flute", "Drum", "Bookshelf"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Spain", "France", "Germany", "Forest"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Lemon", "Orange", "Banana", "Cement"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Carpenter", "Blacksmith", "Plumber", "Shadow"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Desk", "Chair", "Sofa", "Bicycle"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Knife", "Fork", "Spoon", "Napkin"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
