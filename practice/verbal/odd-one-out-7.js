const synqQuestions = [
  {
    ...
    options: ["Pellucid", "Transparent", "Translucent", "Opaque"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Augment", "Enhance", "Amplify", "Diminish"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Tenacious", "Resolute", "Steadfast", "Vacillating"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Esoteric", "Arcane", "Recondite", "Manifest"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Sycophant", "Lackey", "Flatterer", "Disparager"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Candid", "Frank", "Forthright", "Evasive"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Prudent", "Judicious", "Circumspect", "Reckless"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Brusque", "Curt", "Abrupt", "Courteous"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Cacophonous", "Discordant", "Melodious", "Harsh"],
    answer: 2,
    difficulty: "Medium",
    timeLimit: 18,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Sordid", "Sleazy", "Unseemly", "Pristine"],
    answer: 3,
    difficulty: "Medium",
    timeLimit: 18,
  },
