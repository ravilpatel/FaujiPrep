const synqQuestions = [
  {
    prompt: "Choose the antonym of ABSTAIN.",
    options: ["Refrain", "Indulge", "Forbear", "Avoid"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 22,
  },
  {
    prompt: "Choose the antonym of ACCELERATE.",
    options: ["Quicken", "Decelerate", "Hasten", "Speed up"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 22,
  },
  {
    prompt: "Choose the antonym of ACKNOWLEDGE.",
    options: ["Recognize", "Deny", "Admit", "Accept"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 22,
  },
  {
    prompt: "Choose the antonym of ALLEVIATE.",
    options: ["Mitigate", "Aggravate", "Relieve", "Ease"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 22,
  },
  {
    prompt: "Choose the antonym of AMPLIFY.",
    options: ["Magnify", "Reduce", "Enlarge", "Intensify"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 22,
  },
  {
    prompt: "Choose the antonym of APPLAUD.",
    options: ["Praise", "Condemn", "Approve", "Commend"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 22,
  },
  {
    prompt: "Choose the antonym of ASCEND.",
  ...
  {
    prompt: "Choose the antonym of ASPIRE.",
    options: ["Desire", "Despair", "Yearn", "Seek"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    prompt: "Choose the antonym of ATTAIN.",
    options: ["Achieve", "Forfeit", "Obtain", "Gain"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
  {
    prompt: "Choose the antonym of AUGMENT.",
    options: ["Increase", "Diminish", "Expand", "Add"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 23,
  },
