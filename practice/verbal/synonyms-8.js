const synqQuestions = [
  {
    prompt: "Choose the synonym of MERRY.",
    options: ["Cheerful", "Morose", "Depressed", "Somber"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 17,
  },
  {
    prompt: "Choose the synonym of DENSE.",
    options: ["Thick", "Thin", "Sparse", "Light"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 21,
  },
  {
    prompt: "Choose the synonym of MELANCHOLY.",
    options: ["Joy", "Sadness", "Energy", "Excitement"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 23,
  },
  {
    prompt: "Choose the synonym of CREDIBLE.",
    options: ["Believable", "Absurd", "False", "Ridiculous"],
    answer: 0,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of BRISK.",
    options: ["Sluggish", "Lively", "Idle", "Lethargic"],
    answer: 1,
    difficulty: "Medium",
    timeLimit: 22,
  },
  {
    prompt: "Choose the synonym of EXPLICIT.",
    options: ["Clear", "Vague", "Hidden", "Unspoken"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 27,
  },
  {
    prompt: "Choose the synonym of OBSOLETE.",
    options: ["Modern", "Outdated", "Latest", "Current"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of TENACIOUS.",
    options: ["Persistent", "Lazy", "Weak", "Yielding"],
    answer: 0,
    difficulty: "Hard",
    timeLimit: 28,
  },
  {
    prompt: "Choose the synonym of AMBIGUOUS.",
    options: ["Clear", "Uncertain", "Exact", "Precise"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 29,
  },
  {
    prompt: "Choose the synonym of AUSTERE.",
    options: ["Luxurious", "Severe", "Pleasant", "Decorative"],
    answer: 1,
    difficulty: "Hard",
    timeLimit: 30,
  },
