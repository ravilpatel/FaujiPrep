const synqQuestions = [
  {
    ...
    options: ["Red", "Blue", "Green", "Happiness"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Square", "Cube", "Rectangle", "Melody"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Oxygen", "Nitrogen", "Hydrogen", "Towel"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  ...
  {
    prompt: "Which word is the odd one out?",
    options: ["Cricket", "Chess", "Hockey", "Volcano"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["India", "Japan", "Australia", "Rainbow"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Bread", "Rice", "Pasta", "Thunder"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Pencil", "Crayon", "Marker", "Blanket"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Summer", "Winter", "Spring", "Tuesday"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
  {
    prompt: "Which word is the odd one out?",
    options: ["Oxygen", "Helium", "Carbon", "Silk"],
    answer: 3,
    difficulty: "Easy",
    timeLimit: 12,
  },
