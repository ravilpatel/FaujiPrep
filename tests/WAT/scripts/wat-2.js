...
async function fetchWords() {
    ...
    const defaultWords = [
        "Journey", "Window", "Courage", "River", "Failure", "Family", "Mountain", "Help", "Decision", "Garden",
        "Friend", "Problem", "Book", "Leader", "Risk", "Child", "Respect", "Train", "Freedom", "Money",
        "Challenge", "Village", "Trust", "Teacher", "Time", "Change", "Success", "Night", "Responsibility", "Water",
        "Goal", "Fear", "Duty", "Home", "Discipline", "Smile", "Opportunity", "Bridge", "Team", "Future",
        "Patience", "Work", "Tree", "Choice", "Strength", "Road", "Society", "Learning", "Character", "Victory",
        "Peace", "Honesty", "Effort", "Weather", "Service", "Hope", "Growth", "Action", "Truth", "Life"
    ];
